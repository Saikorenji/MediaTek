        <aside>
            <nav>
                <ul>
                    ...
                    <li><a href="./register_form.php" title="S'inscrire"><i class="light-icon-user-plus"></i> S'inscrire</a></li>
                    <!-- <li><a href="./unregister_form.php" title="Se désinscrire"><i class="light-icon-user-minus"></i> Se désinscrire</a></li> -->
                    <li><a href="../" title="Retour au site"><i class="light-icon-home"></i> Retour au site</a></li>
                </ul>
            </nav>
        </aside>